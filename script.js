...
function winGame(){
  stopGame();
  alert("Game Over. You won! Try to beat you score.");
}
...
function updateParagraph() {
    document.getElementById("p1").innerHTML = "Press the buttons in the same order as the original pattern you see and hear them to win.\nCurrent Score: "+curScore+" | High Score: "+highScore;
}
function clearTimer() {
  clearTimeout(timer);
  timeRemaining = 0;
